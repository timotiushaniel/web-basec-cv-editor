...
$tempat = $komputer = $komunikasi = $java = $kepemimpinan = $entrepreneurship = $careerskill = $tanggal = "";
$tempat_err = $komputer_err = $komunikasi_err = $java_err = $kepemimpinan_err = $entrepreneurship_err = $careerskill_err = $tanggal_err = "";
...
if(isset($_POST["pd_id"]) && !empty($_POST["pd_id"])){
    ...
    // Validate name
    $input_tempat = trim($_POST["Certiplus_Program_place"]);
    if(empty($input_tempat)){
        $tempat_err = "Please enter the Certiplus Program place.";
    } else{
        $tempat = $input_tempat;
    }
