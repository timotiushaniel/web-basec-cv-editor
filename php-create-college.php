...
<body>
    ...
    <div class="col-12">
      <div class="tab-pane" id="v-pills-college" role="tabpanel" aria-labelledby="v-pills-college-tab">
          ...
          ?>
          <form action="phpcollege.php" method="POST">
            <div class="form-group mb-3 input-group-sm">
              ...
              <input type="text" class="form-control" id="City_college" name="City_college" placeholder="City">
              <input type="text" class="form-control" id="graduate_degree" name="graduate_degree" placeholder="Graduate degree">
              <input type="text" class="form-control" id="concentration_of_expertise" name="concentration_of_expertise" placeholder="Concentration of expertise">
              <input type="text" class="form-control" id="ipk" name="ipk" placeholder="Indeks Prestasi Kumulatif">
            </div>
            ...
            <br>
            <button type="submit" class="btn btn-primary btn-sm" id="he_submit" name="college_submit">Submit</button><br><br>
