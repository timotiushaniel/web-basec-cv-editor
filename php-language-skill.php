        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                            ...
                            if($language_skill_result = mysqli_query($conn, $language_skill_sql_read)){
                                if(mysqli_num_rows($language_skill_result) > 0){
                                        while($language_skill_row = mysqli_fetch_array($language_skill_result)){
                                            ...
                                            echo "<a href='php-update-language-skill.php?ls_id=". $language_skill_row['ls_id'] ."&lg_id=" . $language_skill_row["lg_id"] . "' title='Update Record' data-toggle='tooltip'>
                                                    <span class='glyphicon glyphicon-pencil'></span>
                                                  </a>";
                                            echo "<a href='php-delete-language-skill.php?ls_id=". $language_skill_row['ls_id'] ."&lg_id=" . $language_skill_row["lg_id"] . "' title='Delete Record' data-toggle='tooltip'>
                    ...
                    <p><a href="php-create-language-skill.php" class="btn btn-success">Add New Language Skill</a>
                    <div class="form-group">
                        <label>Score</label>
