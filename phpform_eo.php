...
if (isset($_POST['Eo_submit'])) {
    ...
    $EmploymentObjective = $_POST['EmploymentObjective'];
    
    if (empty($EmploymentObjective)) {
        header("Location: ./form.php?error=emptyfieldsEmploymentObjective"."&UserEmail=".$CurrentEmail."&UserId=".$UserId);
    }
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if (!mysqli_stmt_prepare($stmt, $sql)) {
                ...
                mysqli_stmt_execute($stmt);
                header("Location: ./form.php?employmentobjective=success"."&UserId=".$UserId);
                exit();
            }
        }
    }
