  ...
  <div class="row">
    <div class="col-3">
      ...
      if (!empty($PersonalDataId)) {
        ...
        <a class="nav-link ml-5 my-1 active" id="v-pills-certiplus-tab" data-toggle="pill" href="certiplus_program.php" role="tab" aria-controls="v-pills-certiplus" aria-selected="false">Certiplus Program</a>
        ...
        <?php
            ...
            if ($ce_result = mysqli_query($conn, $ce_sql_read)) {
                if (mysqli_num_rows($ce_result) > 0) {
                    ...
                    $ce_id = 0;
                    echo "<p class='lead'><em>Certiplus record were not found. Please add Certiplus record first.</em></p>";
                }
            } else {
            ...
            <a href="../create/php-create-certiplus.php">
            ...
            <?php echo "<a href='../update/php-update-certiplus.php?ce_id=" . $ce_id . "'>" ?>
            ...
            <a href="college.php" name="previousCe" class="btn btn-info btn-md" id="previous">Previous</a>
            <a href="professional_certification.php" name="next" class="btn btn-warning btn-md float-right" id="next">Next</a><br><br><br>
        </div>
    </div>
</div>
<!-- END CERTIPUS PROGRAM FORM!-->