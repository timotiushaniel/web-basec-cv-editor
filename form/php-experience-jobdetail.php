        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                            ...
                            if($job_detail_result = mysqli_query($conn, $job_detail_sql_read)){
                                if(mysqli_num_rows($job_detail_result) > 0){
                                        while($job_detail_row = mysqli_fetch_array($job_detail_result)){
                                            ...
                                            echo "<a href='../update/php-update-jobdetail.php?dj_id=". $job_detail_row['dj_id'] ."&ex_id=" . $job_detail_row["ex_id"] . "' title='Update Record' data-toggle='tooltip'>
                                                    <span class='glyphicon glyphicon-pencil'></span>
                                                  </a>";
                                            echo "<a href='../delete/php-delete-jobdetail.php?dj_id=". $job_detail_row['dj_id'] ."&ex_id=" . $job_detail_row["ex_id"] . "' title='Delete Record' data-toggle='tooltip'>
                    ...
                    <p><a href="../create/php-create-jobdetail.php" class="btn btn-success">Add New Job Detail</a>
                    <a href="experience.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
