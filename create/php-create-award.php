                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group <?php echo (!empty($nama_err)) ? 'has-error' : ''; ?>">
                            <label>Award Name / Award Detail</label>
                            <textarea name="nama" class="form-control" placeholder="Example: Nominated for the Dean's List for 8 semesters due to outstanding academic performance. "><?php echo $nama; ?></textarea>
